...
public class HuoyunyuanDBdao {
     ...
     * @return
     */
    public ArrayList<String> getTitle2(String title1) {
        ArrayList<String> arrayList = new ArrayList<String>();
        SQLiteDatabase db = helper.getReadableDatabase();

        Cursor cursor = db.rawQuery(
                "select * from " + HuoyunyuanOperHelper.NAME + " where title1=?",
                new String[]{title1});
        while (cursor.moveToNext()) {
            if (!arrayList.contains(cursor.getString(12))){
                arrayList.add(cursor.getString(12));//11是title1,12是title2
            }
    ...
    public ArrayList<String> getTitle3(String title1,String title2) {
        ArrayList<String> arrayList = new ArrayList<String>();
        SQLiteDatabase db = helper.getReadableDatabase();

        Cursor cursor = db.rawQuery(
                "select * from " + HuoyunyuanOperHelper.NAME + " where title1=? and title2=?",
