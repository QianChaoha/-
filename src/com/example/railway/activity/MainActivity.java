...
public class MainActivity extends BaseActivity implements OnClickListener {
    ...
    HashMap<String, ArrayList<String>> hyyMap = new HashMap<String, ArrayList<String>>();
//    ArrayList<HyyTitle1> hyyTitle = new ArrayList<HyyTitle1>();
    HyyTitle hyyTitle=new HyyTitle();
    @Override
                    ...
                    switch (j) {
                        case 6:
                            ...
                            if (huoyunyuanDBdao.tabbleIsExist()) {
                                ...
                                String json=getSharedPreferences("config",MODE_PRIVATE).getString(Config.HYY_TITLE1,"");
...
//						}
                ...
                if (!TextUtils.isEmpty(title1Str)) {
                    ...
                    String[] title1Arr = title1Str.split(",");
                    ArrayList<HyyTitle1> hyyTtitle1=new ArrayList<HyyTitle1>();
                    for (int i = 0; title1Arr != null && i < title1Arr.length; i++) {
                        HyyTitle1 title1Enyity = new HyyTitle1();
                        title1Enyity.mtitle1=title1Arr[i];

                        //给每个title设置title2
                        ArrayList<String> hyyTitle2 = huoyunyuanDBdao.getTitle2(title1Arr[i]);
                        ArrayList<HyyTitle2> hyyTitle2List =new ArrayList<HyyTitle2>();
                        for (int j = 0; hyyTitle2!=null&&j <hyyTitle2.size() ; j++) {
                            HyyTitle2 mHyyTitle2=new HyyTitle2();
                            mHyyTitle2.title2=hyyTitle2.get(j);
                            //给每个title2设置title3
                            ArrayList<String> hyyTitle3List = huoyunyuanDBdao.getTitle3(title1Arr[i],mHyyTitle2.title2);
                            mHyyTitle2.title3List=hyyTitle3List;
                            //======================
                            hyyTitle2List.add(mHyyTitle2);
                            title1Enyity.title2List=hyyTitle2List;
                        }

                        hyyTtitle1.add(title1Enyity);
                    }
                    hyyTitle.hyyTitle=hyyTtitle1;
                    Gson gson= new Gson();
                    String json= gson.toJson(hyyTitle);
                    getSharedPreferences("config",MODE_PRIVATE).edit().putString(Config.HYY_TITLE1,json).commit();
...
//                   intent.putParcelableArrayListExtra("hyy",hyyTitle);
