...
//		adView.setMarketId((byte) 9);
        ...
        final HuoyunyuanDBdao huoyunyuanDBdao = new HuoyunyuanDBdao(HuoYunYuanActivity.this);
                    ...
                    public void run() {
                        if (huoYunYuans != null) {
                            ...
                            for (int i = 0; i < huoYunYuans.size(); i++) {
                                ...
                                View view = View.inflate(HuoYunYuanActivity.this, R.layout.layout_homework, null);
                                ...
                                switch (huoYunYuans.get(i).type) {
                                    case "单选题":
                                        ...
                                        content = View.inflate(HuoYunYuanActivity.this, R.layout.layout_single_check, null);
                                    ...
                                    case "多选题":
                                        ...
                                        content = View.inflate(HuoYunYuanActivity.this, R.layout.layout_mutiply_check, null);
                                        flContent.addView(content);
                                    ...
                                    case "判断题":
                                        ...
                                        content = View.inflate(HuoYunYuanActivity.this, R.layout.layout_judge, null);
                                        flContent.addView(content);
                            ...
                            mViewPager.setAdapter(new HuoyunyuanAdapter(views, HuoYunYuanActivity.this));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rbCollect:
                ...
                break;
            case R.id.rlSeeAll:
                Intent intent=new Intent(HuoYunYuanActivity.this,SeeAllActivity.class);
